...
execute "mysql" do
  command "mysql -uroot --password= </opt/OpenIMSCore/FHoSS/scripts/hss_db.sql && mysql -uroot --password= </opt/OpenIMSCore/FHoSS/scripts/hss_db_migrate_as_register.sql && mysql -uroot --password= </opt/OpenIMSCore/FHoSS/scripts/userdata.sql"
end
