  ...
  class BoxManager
    ...
    def initialize(cloud, environment, attributes, options = {}, supported_boxes =
      [
        ...
        {:name => "homestead", :security_groups => ["base", "homestead", "vellum"]},
        {:name => "homer", :security_groups => ["base", "homer", "vellum"]},
        {:name => "sprout", :security_groups => ["base", "internal-sip", "sprout", "vellum"]},
        ...
        {:name => "vellum", :security_groups => ["base", "internal-sip", "vellum"]},
        {:name => "dime", :security_groups => ["base", "internal-sip", "homestead", "ralf", "vellum"]},
      ])
