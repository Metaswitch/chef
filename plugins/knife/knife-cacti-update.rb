...
module ClearwaterKnifePlugins
  class CactiUpdate < Chef::Knife
    ...
    def run()
      ...
      find_nodes(roles: "clearwater-base", role: "cacti").each do |cacti|
        find_nodes(roles: "clearwater-base", role: "bono").each do |node|
        ...
        find_nodes(roles: "clearwater-base", role: "sprout").each do |node|
        ...
        find_nodes(roles: "clearwater-base", role: "sipp").each do |node|
